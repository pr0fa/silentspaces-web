/*
  SplashScreen.jsx
  the 2.3 second branded intro shown on first load. purely visual — no state
  or props needed. the App.jsx timer controls when it disappears.
*/
  ...
  return (
    <div className="splash-overlay">
      <div className="splash-content">
        ...
        {/* the logo mark — a map pin with sound wave lines inside */}
