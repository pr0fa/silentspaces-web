/*
  SignUpPage.jsx
  new account creation. mirrors LoginPage's Google sign-in logic because both
  pages support the same redirect flow on mobile.

  after a successful email sign-up we send the user to /onboarding so they can
  set their preferences before landing on the map.
*/
...
export default function SignUpPage() {
  ...
  // same as LoginPage — pick up the google redirect result on return from mobile sign-in
  useEffect(() => {
    setLoading(true);
